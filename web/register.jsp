...
<div class="content-login">
    <div class="left-login">
        <div class="img-left-login">
            <img height="600px" width="350px" src="http://marketingbox.vn/upload/image/%C4%90%E1%BA%B9p-%C4%90%E1%BB%99c-%C4%90%E1%BB%89nh/12-poster/03-thiet-ke-poster-quang-cao-may-tinh.jpg">
        </div>
    </div>
    ...
    <div class="form-login-regeter">
        <form class="form-login-regeter" action="/action_page.php" method="post">
            <div class="imgcontainer ">
                <div class="option">
                    <div class="w3-content w3-section" style="max-width:780px">
                        <img class="mySlides" src="https://cdn.tgdd.vn/2019/11/banner/800-170-800x170-(89).png" style="width:100%">
                        <img class="mySlides" src="https://cdn.tgdd.vn/2019/11/banner/800-170-800x170-(100).png" style="width:100%">
            ...
            <div class=" login-geterform">
                ...
                <input class=" login-geter1" type="text" placeholder="Tên đăng nhập" name="uname" required>

                <label ><b>Email hoặc số điện thoại</b></label>
                <input class=" login-geter1" type="text" placeholder="Email hoặc Số điện thoại" name="uname" required>
...
<!--                <button class="login-buton" type="submit"><a href="sign.html" style="color: #fefefe">Đăng nhập</a></button>-->
                ...
                <div class="container-loginadd" >
                    ...
                    <!--        <button type="button" class="cancelbtn" ><a href="index.html" style="color: #fefefe">Hủy</a></button>-->
                    <a class="cancelbtn"  href="sign.html" >Đăng nhập</a>
                    <span class="adpsw">Quên <a href="forgotpass.html">Mật khẩu?</a></span>

                </div>
<!--                            <button type="button" class="cancelbtn" ><a href="sign.html" style="color: #fefefe">Đăng nhập</a></button>-->
...
<!--                </div>-->
    ...
    <div class="right-login">
        <div class="img-left-login">
            <img height="600px" width="350px" src="https://bitex.com.vn/vnt_upload/File/Image/tintuc2014/don_giang_sinh_ring_dong_ho_cung_Bitex.png">
        </div>
    </div>
</div>
<footer class="footer ">
