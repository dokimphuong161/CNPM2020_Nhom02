            ...
            <div class="col-md-6 col-lg-6 nav-bg-white hidden-sm hidden-xs">
                <ul id="nav" class="nav">
                    ...
                    <li class="nav-item has-mega">
                        <a href="<%=Utils.fullPath("ListProduct") %>" class="nav-link" title="Sản phẩm">Sản phẩm <i class="fa fa-angle-down" data-toggle="dropdown"></i></a>
                        <div class="mega-content">
                            <ul class="level0">
                                <li class="level1 parent item">
                                    <a class="hmega" href="<%=Utils.fullPath("ListProduct") %>" title="Laptop">Tất cả sản phẩm</a>
                                    <ul class="level1">
                                        <%
                    ...
                    <li class="nav-item ">
                        <a href="tintuc.jsp" class="nav-link" title="Tin tức">Tin tức</a>
